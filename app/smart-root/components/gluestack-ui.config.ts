...
export const gluestackUIConfig = createConfig({
  ...
  tokens: {
    colors: {
      ...
      inversePrimary: '#96D5A6',
      primaryFixed: '#B2F1C0',
      onPrimaryFixed: '#00210E',
      primaryFixedDim: '#96D5A6',
      onPrimaryFixedVariant: '#13512D',
      secondaryFixed: '#D2E8D4',
      onSecondaryFixed: '#0D1F13',
      secondaryFixedDim: '#B6CCB8',
      onSecondaryFixedVariant: '#384B3C',
      tertiaryFixed: '#BEEAF6',
      onTertiaryFixed: '#001F26',
      tertiaryFixedDim: '#A2CED9',
      onTertiaryFixedVariant: '#214D57',
      surfaceDim: '#D7DBD4',
      ...
      primaryDark: '#96D5A6',
      surfaceTintDark: '#96D5A6',
      onPrimaryDark: '#00391B',
      primaryContainerDark: '#13512D',
      onPrimaryContainerDark: '#B2F1C0',
      secondaryDark: '#B6CCB8',
      onSecondaryDark: '#223527',
      secondaryContainerDark: '#384B3C',
      onSecondaryContainerDark: '#D2E8D4',
      tertiaryDark: '#A2CED9',
      onTertiaryDark: '#02363F',
      tertiaryContainerDark: '#214D57',
      onTertiaryContainerDark: '#BEEAF6',
      errorDark: '#FFB4AB',
      onErrorDark: '#690005',
      errorContainerDark: '#93000A',
      onErrorContainerDark: '#FFDAD6',
      backgroundDark: '#101510',
      onBackgroundDark: '#DFE4DC',
      surfaceDark: '#101510',
      onSurfaceDark: '#DFE4DC',
      surfaceVariantDark: '#414941',
      onSurfaceVariantDark: '#C1C9BF',
      outlineDark: '#8B938A',
      outlineVariantDark: '#414941',
      shadowDark: '#000000',
      scrimDark: '#000000',
      inverseSurfaceDark: '#DFE4DC',
      inverseOnSurfaceDark: '#2D322D',
      inversePrimaryDark: '#32B76C',
      primaryFixedDark: '#B2F1C0',
      onPrimaryFixedDark: '#00210E',
      primaryFixedDimDark: '#96D5A6',
      onPrimaryFixedVariantDark: '#13512D',
      secondaryFixedDark: '#D2E8D4',
      onSecondaryFixedDark: '#0D1F13',
      secondaryFixedDimDark: '#B6CCB8',
      onSecondaryFixedVariantDark: '#384B3C',
      tertiaryFixedDark: '#BEEAF6',
      onTertiaryFixedDark: '#001F26',
      tertiaryFixedDimDark: '#A2CED9',
      onTertiaryFixedVariantDark: '#214D57',
      surfaceDimDark: '#101510',
      surfaceBrightDark: '#353A35',
      surfaceContainerLowestDark: '#0A0F0B',
      surfaceContainerLowDark: '#181D18',
      surfaceContainerDark: '#1C211C',
      surfaceContainerHighDark: '#262B26',
      surfaceContainerHighestDark: '#313631',
    },
    space: {
      'px': '1px',
      '0': 0,
